...
- [x] 5.1 サイドバーの Home・各プロジェクト・Settings・About へのナビゲーションが動作することを確認する
- [x] 5.2 ハンバーガーボタンで展開・折りたたみが切り替わり、再起動後に状態が復元されることを確認する
- [x] 5.3 アクティブ状態のハイライトが現在の画面に正しく追従することを確認する
